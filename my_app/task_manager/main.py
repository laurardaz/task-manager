...
class MainWindow(QMainWindow):
    ...
    def loaddata(self):
        tasks = [
            {"название": "Сходить в магазин", "описание": "купить еду", "проект": "Домашний", "приоритет": "Средний",
             "начало": "12.01.2023", "окончание": "13.01.2023", "статус": "Выполнена", "действие": "нет"},
            {"название": "Доделать модель", "описание": "покрыть лаком", "проект": "Хобби", "приоритет": "Низкий",
             "начало": "09.01.2023", "окончание": "15.01.2023", "статус": "Выполнена", "действие": "нет"},
            {"название": "Картина", "описание": "купить кисти", "проект": "Хобби", "приоритет": "Низкий",
             "начало": "17.01.2023", "окончание": "18.01.2023", "статус": "Ваполнена", "действие": "нет"},
            {"название": "Высадить цветы", "описание": "купить семена", "проект": "Нет", "приоритет": "Средний",
             "начало": "01.03.2023", "окончание": "04.03.2023", "статус": "В очереди", "действие": "нет"},
            {"название": "Прослушать семинар", "описание": "'https://www.youtube.com/watch?v=hP'", "проект": "Нет",
             "приоритет": "Средний", "начало": "10.02.2023", "окончание": "15.02.2023", "статус": "В очереди",
             "действие": "нет"},
            {"название": "Дочитать книги", "описание": "'Прыжок', 'Лето волонтера'", "проект": "Чтение", "приоритет":
                "Низкий", "начало": "09.01.2023", "окончание": "20.01.2023", "статус": "В очереди", "действие": "нет"}
            ]
        row = 0
